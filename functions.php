...
/** Add Monolith Settings functions */

// require_once( 'monolith/settings/social-media.php' );

/* ~~~~~~~~~~ Add options page to Wordpress with ACF ~~~~~~~~~ */

if( function_exists('acf_add_options_page') ) {
	acf_add_options_page(array(
		'page_title' 	=> 'Campi ya Kanzi',
		'menu_title'	=> 'Campi ya Kanzi',
	...
	acf_add_options_sub_page(array(
		'page_title' 	=> 'Gallery Introduction',
		'menu_title'	=> 'Gallery Introduction',
...
add_image_size( 'post-thumbnail', '650', '350', true);
add_image_size( 'square-gallery-image', '170', '170', true);
...
function my_acf_init() {
    ...
    acf_update_setting('google_api_key', 'AIzaSyC0NUQE6e1fmTSSHP9lLxf-_jcCLVwfM-A');
}
...
/* ~~~~~~~~~~ Replace Input Submit to Button Submit ~~~~~~~~~~ */
...
function sw_theme_assets() {
	...
	// load theme css
	wp_enqueue_style( 'sw-css', get_template_directory_uri() . '/styles/custom.css' );	
	//wp_enqueue_script( 'sw-js', get_template_directory_uri() . '/theme/theme.js', array(), true );
}
